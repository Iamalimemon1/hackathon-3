...
const socialLinks = [
  {
    address: "/icons/facebook.png"
  },
    {
    address: "/icons/x.png"
  },
      {
    address: "/icons/instagram.png"
  },
        {
    address: "/icons/pinterest.png"
  },
          {
    address: "/icons/youtube.png"
  },
]
...
const Footer = () => {
  return (
      ...
      <footer>
        <div className="flex flex-col gap-24 lg:flex-row item-center justify-between justify-self-center border-y-2   2xl:px-[300px] py-16 ">
      ...
      <nav className='flex flex-col items-center lg:items-start gap-5'>
        ...
        <ul className='flex flex-col gap-2 text-[#272343]'>
          ...
          <li className= "text-[#007580] underline hover:text-[#007580]">Desk Chair</li>
      ...
      <div className='flex flex-col gap-3 items-center  lg:items-start text-[#9A9CAA]'>
        <h2>NEWSLETTER</h2>
      ...
      <div className="xl:px-[300px] py-6 flex justify-between items-center">
