...
import ProductInfo from '@/components/data/products'
      ...
      <main className='jusify-self-center flex flex-col items-center py-[100px] gap-24'>
          <section className='flex flex-col  lg:flex-row gap-20'>
              ...
              <article className='flex flex-col gap-12'>
                ...
                <Link href="/cart"><button className='py-[14px] px-[24px] rounded-lg text-center self-start items-center text-white bg-[#029FAE] flex gap-[10px]'> <Image alt='cart' width={24} height={24} src="/cart.png" className='invert'></Image> Add to Cart</button></Link>
              </article>
          ...
          <section className='flex flex-col gap-10 '>
              <div className='flex justify-between'>
                  ...
                  <Link href="/product"><button className='border-b-4 font-bold text-lg'>View all</button></Link>
              </div>
